...
class WMIVBScript implements WMIStub {
    ...
    private static String executeScript(String scriptCode) throws WMIException {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(WMIService.class.getName()).log(Level.SEVERE, "Exception closing in finally", ioe);
            }
        }
    ...
    public String queryObject(String wmiClass, List<String> wmiProperties, List<String> conditions, String namespace, String computerName) throws WMIException {
        ...
        if (wmiProperties == null || wmiProperties.isEmpty()) {
            usedWMIProperties = WMIService.get().VBSEngine().computerName(computerName).namespace(namespace).listProperties(wmiClass);
        } else {
	...
	@Override
	public String getPrinterAttributes(String serverName) throws WMIException {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public String givePrint(String documentName) throws WMIException {
		// TODO Auto-generated method stub
		return null;
	}
